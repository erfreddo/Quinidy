...
<body class="w-auto h-auto all-bg purple-bg d-flex flex-column min-vh-100 text-center">
	...
	<section id="main" class="text-center">
		...
		<h3 class="text-white text-shadow mb-5">Metti alla prova le tue abilità e scopri la tua modalità preferita!</h3>

		<div id="generalCarousel" class="carousel slide carousel-animation mt-5 mb-4">
			<div class="carousel-inner rounded-5">
				<div class="carousel-item active text-center rounded-5 orange-border-hover" data-interval="2000">
					<a role="button" href="#classicQuiz"><img class="w-100 h-50 d-block rounded-5" src="src/img/mode2.png"></a>
				</div>
				<div class="carousel-item text-center rounded-5 orange-border-hover" data-interval="2000">
					<a role="button" href="#4f1p"><img class="w-100 h-50 d-block rounded-5" src="src/img/mode1.png"></a>
				</div>
				<div class="carousel-item text-center rounded-5 orange-border-hover" data-interval="2000">
					<a role="button" href="#discoveryQuiz"><img class="w-100 h-50 d-block rounded-5" src="src/img/mode3.png"></a>
				</div>
			</div>
		...
		<div class="container px-5 text-white margin-main">
			<div class="row gx-5 align-items-center">
				<div class="col-lg-6 order-lg-2">
					<a role="button" href="#classicQuiz"> <img class="img-fluid w-100 h-50 d-block mx-auto rounded-5 shadow orange-border-hover" src="src/img/index2.png"> </a>
				</div>
	...
	<!-- 4 Foto 1 Parola section -->
	<section id="4f1p" class="text-center">
		<div class="container px-5 text-white margin-middle">
			<div class="row gx-5 align-items-center">
				<div class="col-lg-6 order-lg-1">
					<a role="button" href="#4f1p"> <img class="img-fluid w-100 h-50 d-block mx-auto rounded-5 shadow orange-border-hover" src="src/img/index1.png"> </a>
				</div>
				<div class="col-lg-6 order-lg-2">
					<div class="p-5">
	...
	<section id="discoveryQuiz" class="text-center">
		<div class="container px-5 text-white margin-bottom">
			<div class="row gx-5 align-items-center">
				<div class="col-lg-6 order-lg-2">
					<a role="button" href="#discoveryQuiz"> <img class="img-fluid w-100 h-50 d-block mx-auto rounded-5 shadow orange-border-hover" src="src/img/index3.png"> </a>
				</div>
				<div class="col-lg-6 order-lg-1">
					<div class="p-5">
