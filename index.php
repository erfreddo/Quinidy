	...
	<body class="w-auto h-auto all-bg purple-bg d-flex flex-column min-vh-100 text-center">
		...
		<section id="main" class="text-center">
			...
			<div id="generalCarousel" class="carousel slide carousel-animation mt-5 mb-4">
				<div class="carousel-inner rounded-5 orange-border-hover">
					<div class="carousel-item active text-center" data-interval="2000">
						<a role="button" href="#classicQuiz"><img class="w-100 h-50 d-block rounded-5 box-shadow" src="src/img/mode2.png"></a>
					</div>
