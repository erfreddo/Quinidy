...
?>
<!-- Navbar -->
<nav class="navbar navbar-expand-sm navbar-dark mt-2 mb-5 ms-2 me-2 px-1 bg-black bg-opacity-50 rounded fixed-top text-center" style="box-shadow: rgba(17, 12, 46, 0.15) 0px 48px 100px 0px;">
	<?php /* Logo image */
	if (TITLE == "Benvenuto su Quinidy") {
